...
<script type="text/javascript">
	var url = "<?=base_url('bo/kategori/')?>"; //** url assets **//
	...
	function add() {
		$("#modal_title").text("Tambah Kategori Buku");
		$("#param").val("add");
	...
	$('#form_input').validate({
		...
		messages: {
			nama:{
				required: "Nama Kategori Buku Tidak Boleh Kosong!",
				remote  : "Nama Kategori Buku Sudah Tersedia"
			}
		},
		errorElement : 'div',
